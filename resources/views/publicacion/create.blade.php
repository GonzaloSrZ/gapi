...
@section('content')
    ...
    <form action="/publicaciones" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="titulo" name="titulo" type="text" tabindex="1" class="form-control" placeholder="Ingrese titulo">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Descripcion</label>
            <textarea id="descripcion" name="descripcion" tabindex="2" class="form-control" placeholder="Ingrese descripcion"></textarea>
        </div>
        <div class="mb-3">
